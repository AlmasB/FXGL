...
//        getView().translateXProperty().bind(transform.xProperty());
//        getView().translateYProperty().bind(transform.yProperty());
//        getView().rotateProperty().bind(transform.angleProperty());
//    }
//
