...
abstract class EasingInterpolator : Interpolator() {
    ...
    abstract fun easeOut(ratio: Double): Double
    abstract fun easeInOut(ratio: Double): Double
}

object BounceInterpolator : EasingInterpolator() {
...
object ExponentialInterpolator : EasingInterpolator() {
...
object SineInterpolator : EasingInterpolator() {
